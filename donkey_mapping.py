...
try:
    ...
    while True:
        ...
        if line and (line.magnitude() >= MAG_THRESHOLD):
            ...
            # y1 is ALWAYS 0
            # y2 is ALWAYS 91
            print_string = "Line Ok - throttle %d, steering %d - line t: %d°, r: %d, x1: %d, y1: %d, x2: %d, y2: %d, mag: %d" % \
                (throttle_output , steering_output, line.theta(), line.rho(), line.x1(), line.y1(), line.x2(), line.y2(), line.magnitude())
